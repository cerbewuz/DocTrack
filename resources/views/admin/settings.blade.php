<x-layouts.app :userName="$admin_name">
    <x-slot:title>Admin - Settings</x-slot>
    ...
    <div class="max-w-4xl mx-auto space-y-8 pb-12">
        ...
        <div class="grid grid-cols-1 gap-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden transition-all duration-300">
                ...
                <div class="p-8">
                    <a href="{{ route('admin.profile') }}" class="flex items-center justify-between p-4 hover:bg-gray-50 dark:hover:bg-gray-900/50 rounded-2xl transition-all group border border-transparent hover:border-gray-100 dark:hover:border-gray-800">
                        <div class="flex items-center space-x-4">
