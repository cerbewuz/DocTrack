<x-layouts.app :userName="$admin_name">
    <x-slot:title>Admin - Drafts</x-slot>

    <div class="space-y-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Admin: Document Drafts</h1>
                <p class="text-gray-500 dark:text-gray-400 mt-1">Review and complete your unsent document drafts.</p>
            </div>
